<main class="h-screen bg-zinc-800">
  <section class="max-w-2xl mx-auto text-center flex flex-col items-center">
    ...
    <div class="bg-zinc-700 w-1/2 mt-6 rounded-lg">
      <h3 class="text-xl text-white p-1">2 Threads</h3>
      <h3 class="text-xl text-white p-1">512 MB RAM</h3>
      <h3 class="text-xl text-white p-1">4GB SSD</h3>
      <h3 class="text-xl text-white p-1">Included HTTPS and WSS</h3>
      <button class="bg-zinc-800 rounded-lg p-2 text-white mb-2"
        >Closed Alpha</button
      >
    </div>
  </section>
